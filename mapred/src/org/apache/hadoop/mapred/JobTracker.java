...
public class JobTracker implements MRConstants, InterTrackerProtocol,
   ...
   * Assumes JobTracker is locked on the entry
   * @param hostName
   * @return {@link List} of {@link TaskTrackerStatus}
   */
  ...
  public boolean setSafeMode(SafeModeAction safeModeAction)
      throws IOException {
    String user = UserGroupInformation.getCurrentUser().getShortUserName();
  ...
  boolean setSafeModeInternal(SafeModeAction safeModeAction)
      throws IOException {
    if (safeModeAction != SafeModeAction.SAFEMODE_GET) {
