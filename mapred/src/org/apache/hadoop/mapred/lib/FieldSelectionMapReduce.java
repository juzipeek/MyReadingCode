...
public class FieldSelectionMapReduce<K, V> implements Mapper<K, V, Text, Text>, Reducer<Text, Text, Text, Text>
{
	...
	private String specToString()
	{
		...
		sb.append("mapOutputKeyFieldList.length: ").append(mapOutputKeyFieldList.length).append("\n");
	...
	public void map(K key, V val, OutputCollector<Text, Text> output, Reporter reporter) throws IOException
	{
		...
		String newKey = selectFields(fields, mapOutputKeyFieldList, -1, fieldSeparator);
		String newVal = selectFields(fields, mapOutputValueFieldList, allMapValueFieldsFrom, fieldSeparator);
	...
	public void reduce(Text key, Iterator<Text> values, OutputCollector<Text, Text> output, Reporter reporter) throws IOException
	{
		...
		while (values.hasNext())
		{
			...
			String newKey = selectFields(fields, reduceOutputKeyFieldList, -1, fieldSeparator);
			String newVal = selectFields(fields, reduceOutputValueFieldList, allReduceValueFieldsFrom, fieldSeparator);
