...
class PipesNonJavaInputFormat implements InputFormat<FloatWritable, NullWritable>
{
	...
	public RecordReader<FloatWritable, NullWritable> getRecordReader(InputSplit genericSplit, JobConf job, Reporter reporter) throws IOException
	{
	...
	public InputSplit[] getSplits(JobConf job, int numSplits) throws IOException
	{
		...
		return ReflectionUtils.newInstance(job.getClass("mapred.pipes.user.inputformat", TextInputFormat.class, InputFormat.class), job).getSplits(job, numSplits);
	}
