...
public class SocketOutputStream extends OutputStream implements WritableByteChannel
{
	 ...
	 *
	 * @param channel Channel for writing, should also be a {@link SelectableChannel}.
	 ...
	 * @throws EOFException           If end of input file is reached before requested number of
	 *                                bytes are transfered.
	 * @throws SocketTimeoutException If this channel blocks transfer longer than timeout for
	 *                                this stream.
