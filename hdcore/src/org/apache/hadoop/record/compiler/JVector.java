	...
	class JavaVector extends JavaCompType
	{
		...
		void genCompareTo(CodeBuffer cb, String fname, String other)
		{
			...
			cb.append(element.getType() + " " + getId(Consts.RIO_PREFIX + "e2") +
					" = " + other +
					".get(" + getId(Consts.RIO_PREFIX + "vidx") + ");\n");
			element.genCompareTo(cb, getId(Consts.RIO_PREFIX + "e1"), getId(Consts.RIO_PREFIX + "e2"));
		...
		void genReadMethod(CodeBuffer cb, String fname, String tag, boolean decl)
		{
			...
			element.genReadMethod(cb, getId(Consts.RIO_PREFIX + "e"), getId(Consts.RIO_PREFIX + "e"), true);
		...
		void genWriteMethod(CodeBuffer cb, String fname, String tag)
		{
			...
			element.genWriteMethod(cb, getId(Consts.RIO_PREFIX + "e"), getId(Consts.RIO_PREFIX + "e"));
			cb.append("}\n");
