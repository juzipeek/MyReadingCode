...
public class JRecord extends JCompType
{
	...
	class JavaRecord extends JavaCompType
	{
      ...
      if (ct != 0) {
		...
		void genCode(String destDir, ArrayList<String> options) throws IOException
		{
			...
			{
				cb.append("else {\n");
				cb.append("java.util.ArrayList<" + "org.apache.hadoop.record.meta.FieldTypeInfo> typeInfos = " + "(java.util.ArrayList<" +
						"org.apache.hadoop.record.meta.FieldTypeInfo>)" + "(" + Consts.RTI_FILTER + ".getFieldTypeInfos());\n");
	...
	class CppRecord extends CppCompType
	{
		...
		private String name;
		private String module;
		private ArrayList<JField<CppType>> fields = new ArrayList<JField<CppType>>();
