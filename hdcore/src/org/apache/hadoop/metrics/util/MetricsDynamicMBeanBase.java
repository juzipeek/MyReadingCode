  ...
  private final static String AVG_TIME = "AvgTime";
	...
	private void createMBeanInfo()
	{
		...
		for (MetricsBase o : metricsRegistry.getMetricsList())
		{
          ...
          {
            if (MetricsIntValue.class.isInstance(o) || MetricsTimeVaryingInt.class.isInstance(o))
            {
              attributesInfo.add(new MBeanAttributeInfo(o.getName(), "java.lang.Integer", o.getDescription(), true, false, false));
            }
            else
            {
              if (MetricsLongValue.class.isInstance(o) || MetricsTimeVaryingLong.class.isInstance(o))
              {
	...
	public Object invoke(String actionName, Object[] parms, String[] signature) throws MBeanException, ReflectionException
	{
      ...
      if (actionName == null || actionName.equals(""))
      {
		...
		if (!(actionName.equals(RESET_ALL_MIN_MAX_OP)) || mbeanInfo.getOperations().length != 1)
		{
