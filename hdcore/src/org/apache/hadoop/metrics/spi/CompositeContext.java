...
public class CompositeContext extends AbstractMetricsContext
{
	...
	private final ArrayList<MetricsContext> subctxt = new ArrayList<MetricsContext>();
	...
	{
		return (MetricsRecord) Proxy.newProxyInstance(MetricsRecord.class.getClassLoader(), new Class[]{MetricsRecord.class}, new MetricsRecordDelegator(recordName, subctxt));
	}
