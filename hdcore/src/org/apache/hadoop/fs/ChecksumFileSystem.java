...
public abstract class ChecksumFileSystem extends FilterFileSystem
{
	...
	private FSDataOutputStream create(Path f, FsPermission permission, boolean overwrite, boolean createParent, int bufferSize, short replication, long blockSize,
