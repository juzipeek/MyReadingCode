...
public class JConsole extends JFrame implements ActionListener, InternalFrameListener
{
	...
	private class WindowMenu extends JMenu
	{
		...
		private void add(VMInternalFrame vmIF)
		{
			...
			String text = SwingUtilities.layoutCompoundLabel(this, getGraphics().getFontMetrics(getFont()), indexString + " " + vmName, null, 0, 0, 0, 0, viewR, iconR, textR, 0);
	...
	private static void mainInit(final List<String> urls, final List<String> hostNames, final List<Integer> ports, final List<LocalVirtualMachine> vmids,
	                             final ProxyClient proxyClient, final boolean noTile, final boolean hotspot)
	{
		...
		SwingUtilities.invokeLater(new Runnable()
		{
			public void run()
			{
				...
				Rectangle scrBounds = new Rectangle(scrInsets.left, scrInsets.top, scrSize.width - scrInsets.left - scrInsets.right,
