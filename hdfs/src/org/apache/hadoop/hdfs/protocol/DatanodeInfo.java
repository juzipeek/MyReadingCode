...
public class DatanodeInfo extends DatanodeID implements Node
{
	...
	/** Constructor */
	public DatanodeInfo(final String name, final String storageID, final int infoPort, final int ipcPort, final long capacity, final long dfsUsed, final long remaining,
	                    final long lastUpdate, final int xceiverCount, final String networkLocation, final String hostName, final AdminStates adminState)
	{
	...
	public String getNameWithIpcPort(boolean useHostname)
	{
		...
		return useHostname ? getHostName() + ":" + getIpcPort() : getHost() + ":" + getIpcPort();
	}
