...
public class HdfsFileStatus implements Writable
{
	static
	{                                      // register a ctor
		WritableFactories.setFactory(HdfsFileStatus.class, new WritableFactory()
				{
	 ...
	 */
	public HdfsFileStatus(long length, boolean isdir, int block_replication, long blocksize, long modification_time, long access_time, FsPermission permission, String owner,
	                      String group, byte[] path)
	{
		this.length = length;
		this.isdir = isdir;
