...
public class UpgradeObjectCollection
{
	...
	static class UOSignature implements Comparable<UOSignature>
	{
		...
		public int hashCode()
		{
			return version ^ ((type == null) ? 0 : type.hashCode()) ^ ((className == null) ? 0 : className.hashCode());
		}
	}
	...
	{
		assert FSConstants.LAYOUT_VERSION <= versionFrom : "Incorrect version " + versionFrom + ". Expected to be <= " + FSConstants.LAYOUT_VERSION;
