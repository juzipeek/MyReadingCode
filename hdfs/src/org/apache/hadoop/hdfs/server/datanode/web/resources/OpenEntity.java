...
public class OpenEntity
{
	...
	OpenEntity(final DFSDataInputStream in, final long length, final DFSClient dfsclient)
	{
		this.in = in;
		this.length = length;
	...
	public static class Writer implements MessageBodyWriter<OpenEntity>
	{
		...
		@Override
		public void writeTo(OpenEntity e, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders,
